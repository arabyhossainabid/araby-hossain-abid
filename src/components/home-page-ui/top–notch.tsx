  ...
  return (
    <section className="min-h-screen bg-[#0d0d0d] py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[#deff00]/5 rounded-full blur-[120px] opacity-30 animate-pulse" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Top-<span className="bg-gradient-to-r from-[#deff00] to-yellow-300 bg-clip-text text-transparent">Notch</span> Solutions,
            <br />
            Delivered with <span className="bg-gradient-to-r from-[#deff00] to-yellow-300 bg-clip-text text-transparent">Precision</span>
          </h2>
          ...
          {services.map((service, index) => (
            ...
            >
              <Card className="bg-gradient-to-br from-white/10 to-white/5 border-white/10 h-full hover:border-[#deff00]/40 transition-all duration-500 hover:-translate-y-3 group backdrop-blur-sm relative overflow-hidden">
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#deff00]/0 to-[#deff00]/0 group-hover:from-[#deff00]/10 group-hover:to-transparent transition-all duration-500" />

                <CardContent className="p-8 relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#deff00]/20 to-[#deff00]/5 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 border border-[#deff00]/20">
                    <service.icon className="w-8 h-8 text-[#deff00]" />
                  </div>
                  ...
                  <ul className="space-y-3">
                    {service.features.map((feature, i) => (
                      ...
                      >
                        <CheckCircle2 className="w-4 h-4 text-[#deff00] flex-shrink-0" />
                        {feature}
                      </motion.li>
                    ))}
                  </ul>
        ...
        >
          <Card className="bg-gradient-to-br from-[#deff00]/15 via-purple-500/10 to-blue-500/10 border-[#deff00]/30 overflow-hidden relative backdrop-blur-sm">
              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-wrap gap-8 justify-center mt-12 pt-8 border-t border-white/10">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#deff00] mb-1">50+</div>
                    <div className="text-sm text-gray-400">Projects Delivered</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#deff00] mb-1">30+</div>
                    <div className="text-sm text-gray-400">Happy Clients</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#deff00] mb-1">100%</div>
